...
% Axis Labels:
    ...
    ylabel('$\Delta$', 'FontWeight', 'Bold', 'Interpreter', 'latex', 'FontWeight', 'Bold', 'FontSize', FontSize)
...
% Plotting:
    scaleInd = 3;
    fy = 30;
    plot((((Exp1(1:end-3, 1) - 109)*1)/14.8) + 2.2        , Exp1(1:end-3, 2)/fy, 'x', 'Color', [0.9,0.7,0.0], 'MarkerSize', 8, 'LineWidth', 1.5)
    plot((((Exp3(:, 1) - 280)*0.25)/18.5) + 6.8     , Exp3(:, 2)/fy, 'x', 'Color', [0.9,0.7,0.0], 'MarkerSize', 8, 'LineWidth', 1.5)
    plot((((Exp5(:, 1) - 560)*0.15)/21.28) + 10.25  , Exp5(:, 2)/fy, 'x', 'Color', [0.9,0.7,0.0], 'MarkerSize', 8, 'LineWidth', 1.5)
    plot((((Exp7(:, 1) - 850)*0.13)/22.2) + 13.05   , Exp7(:, 2)/fy, 'x', 'Color', [0.9,0.7,0.0], 'MarkerSize', 8, 'LineWidth', 1.5)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    plot(ED1(:, 1)              , ED1(:, 2)                 , 'rs', 'MarkerSize', 10, 'LineWidth', 1.5)
    plot(-DMRG3(10:end-9, 3)    , abs(DMRG3(10:end-9, 6))   , 'rs', 'MarkerSize', 10, 'LineWidth', 1.5)
    plot(-DMRG5(1:end-17, 3)+0.1, DMRG5(1:end-17, 6)        , 'rs', 'MarkerSize', 10, 'LineWidth', 1.5)
    plot(DMRG7(1, 1:end-2)+0.2  , DMRG7(2, 1:end-2)         , 'rs', 'MarkerSize', 10, 'LineWidth', 1.5)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    plot(ED1(:, 1)      , ED1(:, 2)         , 'b.-', 'MarkerSize', 15)
    plot(ED3(:, 1)      , ED3(:, 2)         , 'b.-', 'MarkerSize', 15)
    plot(ED5(:, 1)      , ED5(:, 2)         , 'b.-', 'MarkerSize', 15)
    plot(ED7(1:end-2, 1), ED7(1:end-2, 2)   , 'b.-', 'MarkerSize', 15)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    plot(IT1(3:end, 1), IT1(3:end, 2), 'ko--', 'MarkerFaceColor', 'k')
    plot(IT3(3:end, 1), IT3(3:end, 3), 'ko--', 'MarkerFaceColor', 'k')
    plot(IT5(3:end, 1), IT5(3:end, 3), 'ko--', 'MarkerFaceColor', 'k')
    plot(IT7(2:end, 1) + 0.2, IT7(2:end, 2), 'ko--', 'MarkerFaceColor', 'k')
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Saving:
    fname   = sprintf('Fig_spectral_gap_exp_fitted_lin.pdf');
    hfig    = gcf;
