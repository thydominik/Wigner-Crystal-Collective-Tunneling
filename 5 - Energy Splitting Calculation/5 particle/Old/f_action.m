function [propagator, action, splitt1, splitt2, splitt3, splitt4, splitt5] = f_action(eta, alpha, trajectory, r, z_time, EigValu, propagator, S, VS, analytical, particle_n)
%first the action shift:
shift = f_initshift(eta, alpha, trajectory, particle_n);

disp(['shift = ' num2str(shift)])
%then the actual action of the trajectory:
action = f_actioncalc(trajectory, r, alpha, eta, 200, z_time, (z_time(2) - z_time(1)), shift, particle_n);
