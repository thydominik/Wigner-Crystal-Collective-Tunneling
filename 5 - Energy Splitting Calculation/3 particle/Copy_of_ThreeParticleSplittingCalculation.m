...
for ind = 1:16
    ...
    Trajectory(1, :) = interp1(z, Trajectory(1, :), linspace(-1, 1, 200), 'Spline');
    Trajectory(2, :) = interp1(z, Trajectory(2, :), linspace(-1, 1, 200), 'Spline');
    Trajectory(3, :) = interp1(z, Trajectory(3, :), linspace(-1, 1, 200), 'Spline');
    z = linspace(-1, 1, 200);
