...
for ind = 1:16
    ...
    [Tau0, EigVals, Tauspace] = TauspaceInit(Trajectory, Alpha, Velocity, Eta, PN, NoP, RotationMatrix, beta);
    %Tau0 = - Tau0;
    ...
    % B matrix:
    BMatrix = BSpringMatrixInit(Trajectory, Alpha, Tauspace, Eta, PN, beta);
...
legend
%plot(SPLITTINGS(:, 1), SPLITTINGS(:, 3), 'o-', 'DisplayName', '1D part from ED')
