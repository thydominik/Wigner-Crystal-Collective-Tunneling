...
%set(gca, 'Yscale', 'log')
scatter([2.9 7.4 10.8 13.7], [1 3.1 7.6 22.25],30, 'rd', 'filled', 'LineWidth', 20)
xlabel('\alpha', 'FontSize', 20)
ylabel('\Delta_{p0}', 'FontSize', 20)
xlim([0 17])
ylim([0 60])
hold off
