...
%filename = sprintf('classical_positions_MC_Ne_%d.dat',Ne );
...
% 
% if  Ne==3
% %clasic_pos(3)=-clasic_pos(1);
% %clasic_pos(2)=0.0;
% clasic_pos = linspace(-X1, X1, N+1);
% end
% 
% if Ne==2 
%   clasic_pos(2) = -clasic_pos(1);
% end
% 
% if  Ne==5
%   clasic_pos(4)=-clasic_pos(2);
% clasic_pos(5) = -clasic_pos(1);
% clasic_pos(3)=0.0;
% end
% 
% if  Ne==7
%   clasic_pos(5)=-clasic_pos(3);
% clasic_pos(6) = -clasic_pos(2);
% clasic_pos(7) = -clasic_pos(1);
% clasic_pos(4)=0.0;
% end
